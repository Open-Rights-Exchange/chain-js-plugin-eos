...
class Plugin implements Chain {
  ...
  public get nativeToken(): { defaultUnit: string; symbol: EosSymbol; tokenAddress: EosEntityName; precision: number } {
    return {
  ...
  public composeAction = async (actionType: Models.ChainActionType, args: any): Promise<EosActionStruct> => {
  ...
  /** Return a ChainTransaction class used to compose and send transactions */
  private async newTransaction(options?: Models.TransactionOptions): Promise<EosTransaction> {
    this.assertIsConnected()
  ...
  ): Promise<{ status: Models.TransactionStatus; transaction: EosTransactionHistory }> {
  ...
  /** Returns a public key given a signature and the original data was signed */
  public getPublicKeyFromSignature = (signature: string | Buffer, data: string | Buffer): Models.PublicKey => {
    return eoscrypto.getPublicKeyFromSignature(signature, data) as Models.PublicKey
  }
  ...
  public toEntityName = (value: string): Models.ChainEntityName => {
    return toEosEntityName(value) as Models.ChainEntityName
  }
  ...
  public toDate = (value: string | Date | EosDate): Models.ChainDate => {
    return toEosDate(value) as Models.ChainDate
  }
  ...
  /** Ensures that the value comforms to a well-formed public Key */
  public toPublicKey = (value: string): Models.PublicKey => {
    return toEosPublicKey(value) as Models.PublicKey
  }
  ...
  /** Ensures that the value comforms to a well-formed private Key */
  public toPrivateKey = (value: string): Models.PrivateKey => {
    return toEosPrivateKey(value) as Models.PrivateKey
  }
  ...
  public toSignature = (value: string): Models.Signature => {
    return this.toEosSignature(value) as Models.Signature
  }
